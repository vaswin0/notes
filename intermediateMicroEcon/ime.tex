...
\marginnote{$AP_l$ also depends on capital used.}
...
\[
		RTS(l \ for \  k) = -\frac{dk}{dl} |_{q=q_0}
.\] 


 The particular value of trade-off rate will depend not only on the level of output but also on the quantities of k,l being used.

The isoquant curves is the graph of the implicit function $k(l)$ satisfying  $q_0 = f(k(l),l)$. On differentiating w.r.t l,


$$0 = f_k \frac{dk}{dl} + f_l = MP_k \frac{dk}{dl} + MP_l$$

$$RTS =  -\frac{dk}{dl} | _{q = q_0} =  \frac{MP_l}{MP_k}$
